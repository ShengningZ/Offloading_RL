...
class PowerServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        Args:
            channel: A grpc.Channel.
        """
        self.GetServerPower = channel.unary_unary(
                '/project_data.PowerService/GetServerPower',
                request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
                response_deserializer=project__data__pb2.ServerPower.FromString,
                )
...
def add_PowerServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetServerPower': grpc.unary_unary_rpc_method_handler(
                    servicer.GetServerPower,
                    request_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                    response_serializer=project__data__pb2.ServerPower.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'project_data.PowerService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
...
class PowerService(object):
    ...
    def GetServerPower(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/project_data.PowerService/GetServerPower',
            google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            project__data__pb2.ServerPower.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
